    ...
    <>
      <nav className={styles.navbar}>
        <ul className={styles.list}>
          ...
          <li className={styles.buttons_view}><Link href="/#ercteamdet"><a>Team Details</a></Link></li>
          <li className={styles.buttons_view}><Link href="#contact"><a>Contact Us</a></Link></li>
        </ul>
      </nav> 
